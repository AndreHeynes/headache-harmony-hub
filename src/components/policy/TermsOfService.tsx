...
const TermsOfService: React.FC<TermsOfServiceProps> = ({ selectedCountry }) => {
  return (
    <div className="bg-card p-6 rounded-lg border border-border">
      ...
      <p className="text-muted-foreground mb-4">
        Permission is granted to temporarily access the materials on Recover & Reclaim's website for personal, non-commercial use only. This is the grant of a license, not a transfer of title, and under this license you may not:
      </p>
