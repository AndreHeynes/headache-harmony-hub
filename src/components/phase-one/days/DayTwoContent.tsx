    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        {!completedQuestionnaires['hit-6'] && (
          <Link to="/questionnaire/hit-6" className="p-3 border rounded-md hover:bg-muted transition-colors">
            <h3 className="font-medium">HIT-6</h3>
            <p className="text-sm text-muted-foreground">Headache Impact Test</p>
          </Link>
        )}
